  ...
  data.forEach((item, index) => {
    replaceHtml += `<div class="aphorisms-item">
                      <div class="aphorisms-tags">${
                        item.tags[0] && item.tags.map((item) => `<span>${item.name}</span>`).join("")
                      }
                      </div>
                      ...
                      <div class="aphorisms-item-bottom">
                        ...
                        <div class="aphorisms-icons">
                          ...
                          <div class="share-buttons">
                            <i onclick="Share.vkontakte('http://spiritual-evolution.ru/aphorism/${
                              item.id
                            }','Хороший Афоризм')"
                              class="fa fa-vk" aria-hidden="true"></i>
                            <i onclick="Share.whatsapp('http://spiritual-evolution.ru/aphorism/${
                              item.id
                            }','Хороший Афоризм')"
                              class="fa fa-whatsapp" aria-hidden="true"></i>
                            <i onclick="Share.telegram('http://spiritual-evolution.ru/aphorism/${
                              item.id
                            }','Хороший Афоризм')"
...
document.addEventListener("click", function (e) {
  ...
  if (e.target.closest(".fa-clone")) {
    const aphorismElement = e.target.closest(".fa-clone").parentNode.parentNode.previousElementSibling
      .firstElementChild;
